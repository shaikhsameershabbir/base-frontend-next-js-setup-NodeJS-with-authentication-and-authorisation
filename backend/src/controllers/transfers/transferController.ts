...
// Get child users under the current user
...
export const processTransfer = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
    try {
...
export const getTransferHistory = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
    try {
        const userId = req.user?.userId;
...
export const getTransferStats = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
    try {
        const userId = req.user?.userId;
