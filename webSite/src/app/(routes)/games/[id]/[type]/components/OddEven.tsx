...
const OddEven: React.FC<OddEven> = ({ gameId }) => {
        ...
        <div className="w-full md:flex-1 flex flex-col">
          ...
          <div className="flex gap-4">
            <button
              ...
              onClick={() => setBidDigits("odd")}
            >
              <span className="mr-2">
                <svg width="20" height="20" fill="none" viewBox="0 0 20 20">
                  <circle cx="10" cy="10" r="9" stroke={bidDigits === "odd" ? "#fff" : "#F97316"} strokeWidth="2" fill={bidDigits === "odd" ? "#fff" : "none"} />
                  {bidDigits === "odd" && (
            ...
            <button
              ...
              onClick={() => setBidDigits("even")}
            >
              <span className="mr-2">
                <svg width="20" height="20" fill="none" viewBox="0 0 20 20">
                  <circle cx="10" cy="10" r="9" stroke={bidDigits === "even" ? "#fff" : "#F97316"} strokeWidth="2" fill={bidDigits === "even" ? "#fff" : "none"} />
                  {bidDigits === "even" && (
                    <circle cx="10" cy="10" r="5" fill="#F97316" />
                  )}
                </svg>
