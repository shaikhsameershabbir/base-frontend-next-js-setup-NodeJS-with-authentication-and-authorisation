...
const DoublePanna: React.FC<DoublePannaProps> = ({ marketId, marketName = 'Market', marketResult, gameType }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-2">
      <div className="max-w-4xl mx-auto">
        ...
        <GameTypeNavigation currentGameType="double-panna" marketId={marketId} className="mb-2 sm:mb-4" />
              ...
              <div className="mb-3 sm:mb-4">
                ...
                >
                  <div className="flex items-center justify-center gap-2">
                    ...
                    Select All  {selectedNumber} (₹{selectedAmount})
                  </div>
                </button>
              </div>
            )}
