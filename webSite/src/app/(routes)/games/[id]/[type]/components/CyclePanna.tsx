...
const CyclePanna: React.FC<CyclePannaProps> = ({ marketId, marketName = 'Market', gameType, marketResult }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-2">
      <div className="max-w-4xl mx-auto">
        ...
        <GameTypeNavigation currentGameType="cycle-panna" marketId={marketId} className="mb-2 sm:mb-4" />
        ...
        <form onSubmit={handleSubmit} className="space-y-2 sm:space-y-4">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-2 sm:p-4 border border-gray-100">
            <div className="flex items-center gap-1.5 sm:gap-2 mb-2 sm:mb-4">
              ...
              <h2 className="text-sm sm:text-base font-bold text-gray-800">Enter Cycle Number (10-99)</h2>
            </div>
              ...
              <div className="grid grid-cols-6 sm:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 gap-1 sm:gap-1.5 lg:gap-2">
                {cycleNumbers.map((num) => (
                  <div key={num} className="group">
                    ...
                    <div className={`w-full aspect-square rounded-xl border transition-all duration-200 ${amounts[num] && amounts[num] > 0
