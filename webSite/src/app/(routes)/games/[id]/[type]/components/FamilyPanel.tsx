...
const FamilyPanel: React.FC<FamilyPanelProps> = ({ marketId, marketName = 'Market', gameType, marketResult }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-2">
      <div className="max-w-4xl mx-auto">
        ...
        <GameTypeNavigation currentGameType="family-panel" marketId={marketId} className="mb-2 sm:mb-4" />
