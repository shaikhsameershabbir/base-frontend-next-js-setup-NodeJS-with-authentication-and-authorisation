...
const Triplepanna: React.FC<TriplepannaProps> = ({ marketId, marketName = 'Market', marketResult, gameType }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (total === 0) {
      showError('No Selection', 'Please select at least one triple panna to bet on.');
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-2">
      <div className="max-w-4xl mx-auto">
        ...
        <GameTypeNavigation currentGameType="triple-panna" marketId={marketId} className="mb-2 sm:mb-4" />
              ...
              {triplePannaNumbers.map((digit) => (
                <div key={digit} className="group">
                  ...
                  <button
                    ...
                    className={`w-full aspect-square rounded-xl border transition-all duration-200 disabled:cursor-not-allowed disabled:opacity-50 ${amounts[digit] && amounts[digit] > 0
